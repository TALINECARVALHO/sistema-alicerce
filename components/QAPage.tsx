        ...
        <div className="bg-white p-5 rounded-xl shadow-md border border-slate-200/80">
            <div className="flex justify-between items-start">
                <div>
                    <p className="text-sm font-semibold text-slate-800">
                        <span className="font-bold text-blue-600">{question.supplierName}</span> perguntou em {new Date(question.askedAt).toLocaleString('pt-BR')}
                    </p>
            ...
            {question.answer ? (
                <div className="mt-4 pt-3 border-t border-slate-200">
                  <p className="text-sm font-semibold text-slate-800">
                    <span className="font-bold text-green-600">{question.answeredBy}</span> respondeu em {new Date(question.answeredAt!).toLocaleString('pt-BR')}:
                  </p>
